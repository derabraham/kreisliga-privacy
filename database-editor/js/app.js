...
import { analyzeCareerLeaguePopulation, ensureDatabaseSettings, normalizeDatabaseSettings } from './database-settings.js?v=20260825-01';
...
function renderDatabaseSettings(){
  els.title.textContent='Database Settings';els.subtitle.textContent='Era, finance, globalization and career-league settings stored in data/metadata.json and shared with the mobile editor.';
